...
public class Devices {
    ...
    // Motor Controllers
    public static final WPI_TalonSRX talonSrxMecWheelFrontLeft = new WPI_TalonSRX(12); // 1 motor
    public static final WPI_TalonSRX talonSrxMecWheelRearLeft = new WPI_TalonSRX(4); // 1 motor
    public static final WPI_TalonSRX talonSrxMecWheelFrontRight = new WPI_TalonSRX(14); // 1 motor
