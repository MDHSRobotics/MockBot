...
public class ClawWheelEject extends Command {

    public ClawWheelEject() {
        Logger.setup("Constructing Command: ClawWheelEject...");
    ...
    protected void initialize() {
        Logger.action("Initializing Command: ClawWheelEject...");
