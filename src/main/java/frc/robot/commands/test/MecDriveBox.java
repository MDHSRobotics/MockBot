...
public class MecDriveBox extends Command {
    ...
    public MecDriveBox(double targetDistanceInFeet, double speed) {
        Logger.setup("Constructing Command: MecDriveBox...");
    ...
    protected void initialize() {
        Logger.action("Initializing Command: MecDriveBox...");
    ...
    @Override
    protected void end() {
        Logger.ending("Ending Command: MecDriveBox...");
    ...
    protected void interrupted() {
        Logger.ending("Interrupting Command: MecDriveBox...");
